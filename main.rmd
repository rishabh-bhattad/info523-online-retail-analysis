...
```{r}
install_package <- c("tidyverse", "lubridate", "arules", "arulesViz", "cluster", "factoextra", "caret", "reshape2", "pROC", "randomForest")
...
cust_level_aggregation <- retail_clean %>%
  group_by(CustomerID) %>%
  summarise(
    total_amt_spent = sum(TotalPrice),
    total_quantity = sum(Quantity),
    num_of_orders = n_distinct(InvoiceNo),
    average_spent_order = mean(TotalPrice),
    average_items_per_order = total_quantity/num_of_orders,
